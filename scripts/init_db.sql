...
CREATE TABLE IF NOT EXISTS user_state (
    ...
    mode TEXT NOT NULL DEFAULT '',          -- '' | practice_compose | practice_translate | paused_compose | paused_translate | reminder | srs_offer | confirm_save | await_word | ask | ask_wait
